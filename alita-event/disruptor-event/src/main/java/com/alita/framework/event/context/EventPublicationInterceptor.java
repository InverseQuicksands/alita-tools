...
public class EventPublicationInterceptor implements MethodInterceptor, DisruptorEventPublisherAware, InitializingBean {
    ...
    public void setApplicationEventClass(Class<?> applicationEventClass) {
        if (DisruptorBindEvent.class == applicationEventClass || !DisruptorBindEvent.class.isAssignableFrom(applicationEventClass)) {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        DisruptorBindEvent event = (DisruptorBindEvent) this.applicationEventClassConstructor.newInstance(new Object[] {invocation.getThis()});
